...
ATTRIBUTES = [
    {"id": 1, "code": "S", "name": "Strength",     "material_name": "Damascus Steel",      "icon_key": "attr_strength"},
    {"id": 2, "code": "P", "name": "Perception",   "material_name": "Quartz Lens",        "icon_key": "attr_perception"},
    {"id": 3, "code": "E", "name": "Endurance",    "material_name": "Carbon Fiber",       "icon_key": "attr_endurance"},
    {"id": 4, "code": "C", "name": "Charisma",     "material_name": "Resonance Crystal",  "icon_key": "attr_charisma"},
    {"id": 5, "code": "I", "name": "Intelligence", "material_name": "Binary Essence",        "icon_key": "attr_intelligence"},
    {"id": 6, "code": "A", "name": "Agility",      "material_name": "Inertial Catalyst",   "icon_key": "attr_agility"},
    {"id": 7, "code": "L", "name": "Luck",         "material_name": "Stardust",     "icon_key": "attr_luck"},
]

# Prestige Buff Catalog 
BUFF_TYPES = [
    # Material gain buffs
    {"id": 1,  "code": "MATERIAL_BONUS_S", "display_name": "+5% Damascus Steel",     "target_type": "MATERIAL", "attribute_id": 1, "bonus_percent": Decimal("5.00")},
    {"id": 2,  "code": "MATERIAL_BONUS_P", "display_name": "+5% Quartz Lens",      "target_type": "MATERIAL", "attribute_id": 2, "bonus_percent": Decimal("5.00")},
    {"id": 3,  "code": "MATERIAL_BONUS_E", "display_name": "+5% Carbon Fiber",     "target_type": "MATERIAL", "attribute_id": 3, "bonus_percent": Decimal("5.00")},
    {"id": 4,  "code": "MATERIAL_BONUS_C", "display_name": "+5% Resonance Crystal","target_type": "MATERIAL", "attribute_id": 4, "bonus_percent": Decimal("5.00")},
    {"id": 5,  "code": "MATERIAL_BONUS_I", "display_name": "+5% Binary Essence",      "target_type": "MATERIAL", "attribute_id": 5, "bonus_percent": Decimal("5.00")},
    {"id": 6,  "code": "MATERIAL_BONUS_A", "display_name": "+5% Inertial Catalyst", "target_type": "MATERIAL", "attribute_id": 6, "bonus_percent": Decimal("5.00")},
    {"id": 7,  "code": "MATERIAL_BONUS_L", "display_name": "+5% Stardust",   "target_type": "MATERIAL", "attribute_id": 7, "bonus_percent": Decimal("5.00")},
    # XP gain buffs
    {"id": 8,  "code": "XP_BONUS_S", "display_name": "+5% XP on Strength",     "target_type": "XP", "attribute_id": 1, "bonus_percent": Decimal("5.00")},
    {"id": 9,  "code": "XP_BONUS_P", "display_name": "+5% XP on Perception",   "target_type": "XP", "attribute_id": 2, "bonus_percent": Decimal("5.00")},
    {"id": 10, "code": "XP_BONUS_E", "display_name": "+5% XP on Endurance",    "target_type": "XP", "attribute_id": 3, "bonus_percent": Decimal("5.00")},
    {"id": 11, "code": "XP_BONUS_C", "display_name": "+5% XP on Charisma",     "target_type": "XP", "attribute_id": 4, "bonus_percent": Decimal("5.00")},
    {"id": 12, "code": "XP_BONUS_I", "display_name": "+5% XP on Intelligence", "target_type": "XP", "attribute_id": 5, "bonus_percent": Decimal("5.00")},
    {"id": 13, "code": "XP_BONUS_A", "display_name": "+5% XP on Agility",      "target_type": "XP", "attribute_id": 6, "bonus_percent": Decimal("5.00")},
    {"id": 14, "code": "XP_BONUS_L", "display_name": "+5% XP on Luck",         "target_type": "XP", "attribute_id": 7, "bonus_percent": Decimal("5.00")},
]
